...
public class C03_SoftAssertion {
    ...
    public void hardAssertion(){
        /*
            ...
            Istersek TsetNG assertion failed olse bile
        ...
        Assert.assertTrue(sayi % 2 == 0,"Sayi cift olamali"); // sayi cift mi?

        Assert.assertTrue(sayi>100,"Sayi 100'den buyuk olmali"); // sayi 100'den buyuk mu?

        Assert.assertTrue(sayi < 1000,"Sayi 1000'den kucuk mu?"); // sayi 1000'den kucuk mu?
    ...
    public void softAssertionTesti(){
        ...
        softAssert.assertTrue(sayi % 2 == 0,"Sayi cift olamali"); // sayi cift mi?

        softAssert.assertTrue(sayi>100,"Sayi 100'den buyuk olmali"); // sayi 100'den buyuk mu?

        softAssert.assertTrue(sayi < 1000,"Sayi 1000'den kucuk mu?"); // sayi 1000'den kucuk mu?

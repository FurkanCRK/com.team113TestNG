...
public class C02_RaporluSoftAssert extends TestBaseRapor {
    ...
    public void test01() throws InterruptedException {
        extentTest = extentReports.createTest("Allert test",
        ...
        extentTest.info("Kullanici herokuapp sayfasina gider");
        ...
        softAssert.assertEquals(actualAlertYazisi,expectedAlertYazisi,"allertteki yazi belirlenenden farkli");
